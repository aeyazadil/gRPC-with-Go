...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\bmessages\x18\x01 \x03(\tR\bmessages2\xd9\x02\n" +
	"\fGreetService\x12@\n" +
	...
	"\x1bHelloBidirectionalStreaming\x12\x1b.greet_service.HelloRequest\x1a\x1c.greet_service.HelloResponse(\x010\x01B\tZ\a./protob\x06proto3"
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	1, // 3: greet_service.GreetService.HelloBidirectionalStreaming:input_type -> greet_service.HelloRequest
	...
	2, // 7: greet_service.GreetService.HelloBidirectionalStreaming:output_type -> greet_service.HelloResponse
